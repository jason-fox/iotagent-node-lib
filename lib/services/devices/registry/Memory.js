...
class DeviceRegistryMemory {
     ...
     */
    getDevicesByService(service, subservice) {
    ...
    list(type, service, subservice, limit, offset, callback) {
        const result = [];
        let skipped = 0;
        const deviceList = this.getDevicesByService(service, subservice);
    ...
    getByName(name, service, subservice, callback) {
...
module.exports = DeviceRegistryMemory;
