...
function updateEntityNgsi2(deviceData, updatedDevice, callback) {
    ...
    jsonConcat(options.json, DeviceHandlerV2.formatAttributes(deviceData.active, false));
    jsonConcat(options.json, DeviceHandlerV2.formatAttributes(deviceData.staticAttributes, true));
    jsonConcat(options.json, DeviceHandlerV2.formatCommands(deviceData.commands));
    ...
    if (Object.keys(options.json).length === 0 && options.json.constructor === Object) {
        ...
        request(options, DeviceHandlerV2.updateEntityHandler(deviceData, updatedDevice, callback));
    }
}

class DeviceHandlerV2 {
    /**
     ...
     * @return {function}               Handler to pass to the request() function.
     */
    static updateEntityHandler(deviceData, updatedDevice, callback) {
     ...
     */
    static formatAttributes(originalVector, staticAtts) {
        const attributeList = {};
     ...
     */
    static formatCommands(originalVector) {
        const attributeList = {};
...
module.exports = DeviceHandlerV2;
