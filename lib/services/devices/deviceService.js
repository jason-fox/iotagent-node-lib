...
const DeviceHandlerLD = require('./handlers/devicesLD');
const DeviceHandlerV2 = require('./handlers/devicesV2');
const DeviceHandlerMixed = require('./handlers/devicesMixed');
const DeviceHandlerV1 = require('./handlers/devicesV1');
...
function init() {
    switch (config.ngsiVersion()) {
        case 'ld':
            deviceHandler = new DeviceHandlerLD();
            break;
        case 'v2':
            deviceHandler = new DeviceHandlerV2();
            break;
        case 'mixed':
            deviceHandler = new DeviceHandlerMixed();
            break;
        default:
            deviceHandler = new DeviceHandlerV1();
    }
}
