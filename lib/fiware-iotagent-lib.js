...
const DeviceRegistryMongoDB = require('./services/devices/registry/MongoDB');
const DeviceRegistryMemory = require('./services/devices/registry/Memory');
...
function doActivate(newConfig, callback) {
    ...
    if (newConfig.deviceRegistry && newConfig.deviceRegistry.type && newConfig.deviceRegistry.type === 'mongodb') {
        ...
        registry = new DeviceRegistryMongoDB(newConfig.iotManager);
        ...
        registry = new DeviceRegistryMemory();
